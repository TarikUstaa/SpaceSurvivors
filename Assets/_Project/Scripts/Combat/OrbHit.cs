...
namespace SpaceSurvivors.Combat
{
    ...
    public class OrbHit : MonoBehaviour, IPoolable
    {
        ...
        public void Configure(float damage, float interval, GameObject owner, WeaponData weapon = null)
        {
            _damage = damage;
        ...
        private void TryHit(Collider2D other)
        {
            ...
            if (target.TakeDamage(new DamageInfo(_damage, _owner, transform.position, Vector2.zero)))
